...
<body>
	...
	<div class="row" style="position: relative">
		<div class="col-md-6" style="margin: auto auto">
			...
			<div class="container">
				<form id="myForm" action="http://localhost:8081/E-BookStore/BuyOrderServlet?username=${pageContext.request.userPrincipal.name}" method="POST">
					<input type="hidden" name="bookId" id="bookId" value= "${book.bookId}" />
					<input type="hidden" name="qty" id="qty" value="${book.quantity}" />
					<div class="row">
						<div class="col-50">
